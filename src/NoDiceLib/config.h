...
extern struct NoDice_configuration {
    ...
    struct NoDice_game {
        ...
        struct NoDice_tileset {
            ...
            const char
                *rootfile;  // Name of ASM file which defines the layout includes for this tileset; if null, use "path"
        ...
        struct NoDice_map_special_tile {
            ...
            unsigned char
                tileset;  // If "tilelayout" is specified, this provides the tileset to be used (otherwise ignored)
