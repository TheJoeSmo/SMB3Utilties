...
struct SMB3_RAM _ram[SMB3RAM_TOTAL] = {
    ...
    {"Vert_Scroll_Hi", 0},      //  Provides a "High" byte for vertically scrolling
    ...
    {"TileAddr_Off", 0},        //  During level loading, specifies an offset into the
    ...
    {"World_Num", 0},           //  Current world index (0-8, where 0 = World 1, 7 =
                                //  World 8, 8 = World 9 / Warp Zone)
    {"PalSel_Tile_Colors", 0},  //  Stores value to index which tile color set to use when palette
                                //  loading routine is called
    {"PalSel_Obj_Colors", 0},   //  Stores value to index which object color set
                                //  to use when palette loading routine is called
    {"Map_Objects_Itm", 0},     //
    {"Level_AltTileset", 0},    //  Pointer to level's "alternate" tileset (when
                                //  you go into bonus pipe, etc.)
    {"Level_BG_Page1_2", 0},    //  Sets which bank the first and second page (2K
                                //  / 64 8x8 tiles) of BG is using
    {"Map_Objects_Y", 0},       //
    {"Map_Objects_XLo", 0},     //
    {"Map_Objects_XHi", 0},     //
    {"Map_Objects_IDs", 0},     //
