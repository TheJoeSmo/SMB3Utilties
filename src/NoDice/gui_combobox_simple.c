...
static gboolean gui_combobox_simple_set_selected_foreach_callback(
    GtkTreeModel *model, GtkTreePath *path, GtkTreeIter *iter, gpointer data) {
    struct _gui_combobox_simple_set_selected_foreach_callback_data *tree_data =
        (struct _gui_combobox_simple_set_selected_foreach_callback_data *) data;
    int this_index;
...
void gui_combobox_simple_set_selected(GtkWidget *widget, int index) {
    ...
    struct _gui_combobox_simple_set_selected_foreach_callback_data
        gui_combobox_simple_set_selected_foreach_callback_data;
    ...
    gtk_tree_model_foreach(
        model,
        gui_combobox_simple_set_selected_foreach_callback,
        (gpointer) &gui_combobox_simple_set_selected_foreach_callback_data);
}
