...
static gboolean gui_listbox_set_index_foreach_callback(
    GtkTreeModel *model, GtkTreePath *path, GtkTreeIter *iter, gpointer data) {
    struct _gui_listbox_set_index_foreach_callback_data *tree_data =
        (struct _gui_listbox_set_index_foreach_callback_data *) data;
    int this_index;
...
void gui_listbox_set_index(GtkWidget *listbox, int index) {
    ...
    gtk_tree_model_foreach(
        model,
        gui_listbox_set_index_foreach_callback,
        (gpointer) &gui_listbox_set_index_foreach_callback_data);
